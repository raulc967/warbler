...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u1 = User.signup("Elmo", "test1@test.com", "password", None)
        self.u1_id = 778
        self.u1.id = self.u1_id
        self.u2 = User.signup("Cookie", "test2@test.com", "password", None)
        self.u2_id = 884
        self.u2.id = self.u2_id
        self.u3 = User.signup("Chewy", "test3@test.com", "password", None)
        self.u4 = User.signup("R2-D2", "test4@test.com", "password", None)
    ...
    def test_users_index(self):
        with self.client as c:
            ...
            self.assertIn("@Elmo", str(resp.data))
            self.assertIn("@Cookie", str(resp.data))
            self.assertIn("@Chewy", str(resp.data))
            self.assertIn("@R2-D2", str(resp.data))
    ...
    def test_users_search(self):
        with self.client as c:
            ...
            self.assertNotIn("@Chewy", str(resp.data))
            self.assertNotIn("@R2-D2", str(resp.data))
    ...
    def test_show_followers(self):
        ...
        with self.client as c:
            ...
            self.assertIn("@Elmo", str(resp.data))
            self.assertNotIn("@Cookie", str(resp.data))
            self.assertNotIn("@Chewy", str(resp.data))
            self.assertNotIn("@R2-d2", str(resp.data))
    ...
    def test_unauthorized_following_page_access(self):
        ...
        with self.client as c:
            ...
            self.assertEqual(resp.status_code, 200)
            self.assertNotIn("@Elmo", str(resp.data))
            self.assertIn("Access unauthorized", str(resp.data))
